          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-6">
                <div className="inline-flex items-center px-4 py-2 bg-brand-100 rounded-full border border-brand-200">
                  <div className="w-2 h-2 bg-brand-primary rounded-full animate-pulse mr-3"></div>
                  <span className="text-brand-700 text-sm font-medium">AI-Powered Learning Platform</span>
                </div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                  ...
                  Generate custom learning paths for any subject with our AI-powered platform.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    className="group relative bg-brand-primary hover:bg-brand-700 text-white px-8 py-4 text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-brand-500/25 transform hover:-translate-y-1 transition-all duration-300"
                  >
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid md:grid-cols-3 gap-8">
             <div className="text-center group">
               <div className="inline-flex items-center justify-center w-16 h-16 bg-brand-primary rounded-2xl mb-4 group-hover:scale-110 transition-transform">
           ...
           {[
             {
               ...
               description: "Our intelligent system instantly creates personalized learning content based on your preferences and goals.",
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
           {[
             ...
             <div key={index} className={`group p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4 ${
               style.color === 'brand' ? 'border-brand-500' : 
               style.color === 'green' ? 'border-green-500' : 
               'border-orange-500'
             }`}>
               <div className="text-center">
                 <div className={`inline-flex items-center justify-center w-12 h-12 ${
                   style.color === 'brand' ? 'bg-brand-100 text-brand-600' : 
     ...
     <section className="py-24 bg-brand-primary">
       <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
         ...
         <div className="space-y-6">
           <Button
             onClick={() => router.push('/login')}
             className="group bg-white text-brand-primary hover:bg-gray-50 px-8 py-4 text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-white/25 transform hover:-translate-y-1 transition-all duration-300"
           >
             <span className="flex items-center">
           ...
           <p className="text-brand-200 text-sm">
             Secure Google authentication • Generate content in under 60 seconds • No commitment required
           </p>
         </div>
       </div>
     </section>
